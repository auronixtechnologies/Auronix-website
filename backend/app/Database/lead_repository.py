...
class LeadRepository:
    ...
    @staticmethod
    def get_all(db: Session, skip: int = 0, limit: int = 100, status: Optional[str] = None) -> List[Dict[str, Any]]:
    ...
    @staticmethod
    def get_by_id(db: Session, lead_id: int) -> Optional[Dict[str, Any]]:
    ...
    @staticmethod
    def update(db: Session, lead_id: int, **kwargs) -> Optional[Dict[str, Any]]:
        """Update a lead."""
        set_clauses = []
